function TraCKer_2D_subplot_v1_0(filename,frames,windowsize)
...
Version 0.0 created by Comert Kural
Version 1.0 by Josh Ferguson
...
while k ~= 4 %4 menu options, and the last option closes
    if l == 2
        [Tx,Ty] = ginput(1); %the goal is to click on a trace to see it in more detail
    end
    for m=1:Boy2
